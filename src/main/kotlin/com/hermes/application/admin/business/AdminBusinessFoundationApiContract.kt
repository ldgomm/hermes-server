...
object AdminBusinessFoundationApiContract {
    val routes: List<AdminBusinessFoundationRouteContract> = listOf(
        ...
        AdminBusinessFoundationRouteContract("PUT", "/api/v1/admin/activities/{activityId}", "Update business activity"),
        AdminBusinessFoundationRouteContract("POST", "/api/v1/admin/activities/{activityId}/activate", "Activate business activity"),
        AdminBusinessFoundationRouteContract("POST", "/api/v1/admin/activities/{activityId}/deactivate", "Deactivate business activity"),
        ...
        AdminBusinessFoundationRouteContract("POST", "/api/v1/admin/branches/{branchId}/deactivate", "Deactivate branch"),
        AdminBusinessFoundationRouteContract("GET", "/api/v1/admin/emission-points", "List emission points"),
        AdminBusinessFoundationRouteContract("GET", "/api/v1/admin/emission-points/{emissionPointId}", "Get emission point"),
        AdminBusinessFoundationRouteContract("POST", "/api/v1/admin/emission-points", "Create emission point"),
        AdminBusinessFoundationRouteContract("PUT", "/api/v1/admin/emission-points/{emissionPointId}", "Update emission point"),
        AdminBusinessFoundationRouteContract("POST", "/api/v1/admin/emission-points/{emissionPointId}/activate", "Activate emission point"),
        AdminBusinessFoundationRouteContract("POST", "/api/v1/admin/emission-points/{emissionPointId}/deactivate", "Deactivate emission point"),
    )
}
