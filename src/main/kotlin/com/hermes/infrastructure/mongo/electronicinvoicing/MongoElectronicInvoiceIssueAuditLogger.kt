...
class MongoElectronicInvoiceIssueAuditLogger(
    ...
    override fun log(event: ElectronicInvoiceIssueAuditEvent) {
        ...
        collection.insertOne(
            Document(MongoDocumentFields.ID, "eiaudit_" + UUID.randomUUID().toString().replace("-", ""))
                ...
                .append("module", "electronic_invoicing")
                .append("context", "electronic_invoice_issue")
                .append("actorUserId", event.actorUserId)
                .append("action", event.action.name)
                .append("entityType", "electronic_invoice_issue")
                .append("entityId", event.documentId)
                .append("targetId", event.documentId)
                ...
                .append(
                    "metadata",
                    Document("documentId", event.documentId)
                        .append("saleId", event.saleId)
                        .append("accessKey", event.accessKey),
                ),
        )
