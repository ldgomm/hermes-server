...
private fun OrganizationSriSettings.toDocument(): Document = Document()
    .append(MongoDocumentFields.ID, organizationId)
    .append(MongoDocumentFields.ORGANIZATION_ID, organizationId)
    .append("environment", environment.storageValue)
    .append("ruc", ruc)
    .append("legalName", legalName)
    .append("commercialName", commercialName)
    .append("matrixAddress", matrixAddress)
    .append("establishmentAddress", establishmentAddress)
    .append("establishmentCode", establishmentCode)
    .append("emissionPointCode", emissionPointCode)
    .append("series", series.value)
    .append("invoiceSchemaVersion", invoiceSchemaVersion.version)
    .append("invoiceSchemaVersionCode", invoiceSchemaVersion.schemaVersionCode)
    .append("specialTaxpayerCode", specialTaxpayerCode)
    .append("obligatedToKeepAccounting", obligatedToKeepAccounting)
    .append("rimpeLegend", rimpeLegend)
    .append("productionEnabled", productionEnabled)
    .append(MongoDocumentFields.CREATED_AT, Date.from(createdAt))
    .append(MongoDocumentFields.CREATED_BY, updatedBy)
    .append(MongoDocumentFields.UPDATED_AT, Date.from(updatedAt))
    .append(MongoDocumentFields.UPDATED_BY, updatedBy)
    .append(MongoDocumentFields.VERSION, version)
    .append(MongoDocumentFields.SCHEMA_VERSION, schemaVersion)
